...
namespace RoomReservationApp
{
    public partial class CustomerForm : Form
    {
        ...
        {
            int age;
            if (!string.IsNullOrEmpty(txtAddName.Text) && !string.IsNullOrEmpty(txtAddAddress.Text) &&
                !string.IsNullOrEmpty(txtAddPhone.Text)
                && !string.IsNullOrEmpty(txtAddGender.Text) && !string.IsNullOrEmpty(txtAddAge.Text) && 
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtId.Text) && !string.IsNullOrEmpty(txtName.Text) 
                ...
                && !string.IsNullOrEmpty(txtGender.Text) && !string.IsNullOrEmpty(txtAge.Text) 
